from retrobiocat_web.analysis.ehreact.helpers.rdkit import moltosmiles_transition, mol_transition
from retrobiocat_web.analysis.ehreact.diagram.diagram import Diagram
from copy import deepcopy
from rdkit import Chem
from retrobiocat_web.analysis.ehreact.helpers.utils import findsubsets
import numpy as np

def one_node_hasse(smi):
    d = Diagram()
    d.add_node(
        key_node=smi,
        rule=Chem.MolFromSmiles(smi),
        is_leaf=True,
        key_parent_node="",
        quiet=True,
    )

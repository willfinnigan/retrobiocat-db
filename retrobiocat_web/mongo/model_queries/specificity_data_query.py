from retrobiocat_web.mongo.models.biocatdb_models import Activity, Molecule
...
def get_unique_smiles(col_name):
    smis = Activity.objects().distinct(col_name)
    return smis

def get_fp_smiles():
    smis = Molecule.objects().distinct('smiles')
    return smis
...
if __name__ == '__main__':
    ...
    smis = get_unique_smiles('substrate_1_smiles')
    print(smis)

...
def add_cofactors(graph, edges):
    for i, edge in enumerate(edges):
        ...
        if graph.nodes[edge['from']]['attributes']['node_type'] == 'reaction':
            if graph.nodes[edge['from']]['attributes']['reaction_type'] == 'retrobiocat':

                node = edge['from']
                colour = 'red'
                selected_enzyme = graph.nodes[node]['attributes']['metadata']['selected_enzyme']
                cofactors = graph.nodes[node]['attributes']['metadata']['enzyme_cofactors']
            ...
            if graph.nodes[edge['to']]['attributes']['reaction_type'] == 'retrobiocat':

...
from retrobiocat_web.retro.retrosynthesis_engine.rule_application.components.bracket_cleaner import BracketCleaner
from retrobiocat_web import logging
from retrobiocat_web.retro.retrosynthesis_engine.rule_application.rdchiral.clean import \
...
class Result_Parser():
    ...
    def __init__(self, config=None, log_level='WARNING'):
        ...
        self.logger = logging.add_logger("Result_Parser", level=log_level)

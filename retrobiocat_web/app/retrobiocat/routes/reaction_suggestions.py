...
from retrobiocat_web.mongo.models.reaction_misc_models import ReactionSuggestion
import yaml
...
def delete_reaction_suggestion():
    ...
    if current_user.is_authenticated:
        user = user_datastore.get_user(current_user.id)
        if sug.owner == user or user.has_role('rxn_rules_admin'):
            sug.delete()
...
if __name__ == '__main__':
    ...
    ReactionSuggestion.drop_collection()

...
def get_issue_data(issues):
    ...
    for issue in issues:
        ...
        data['date'] = issue.date.isoformat()
...
def activity_data_issues_table():
    ...
    return render_template('activity_data_issues/activity_issues_table.html', activity_data_issues_data=issues_data)
...
def activity_data_issue(issue_id):
    ...
    return render_template('activity_data_issues/activity_issue_page.html',
